...
source "azure-arm" "win11_24h2_avd_sap" {
    ...
    shared_image_gallery_destination {
        ...
        image_name          = "azure_windows_11_baseos_avd_sap800_24h2"
        image_version       = "17.01.2026"
...
build {
    ...
    sources = ["source.azure-arm.win11_24h2_avd_sap"]
    #timeout = "16h"
/*
...
*/
  ...
  ##############################################
   ...
   ##############################################
  # 2. Install SAP Application Components
  ##############################################
    provisioner "powershell" {
        inline = [
        "$path = 'C:\\AVDImage'",
        ...
        "}",
        "cd C:\\AVDImage",
        "Invoke-WebRequest -Uri 'https://avdweustc03.blob.core.windows.net/source/AIB_AVD_SAP800_InstallApps.ps1' -OutFile 'C:\\AVDImage\\AIB_AVD_SAP800_InstallApps.ps1'",
        "Start-Sleep -seconds 30",
        "& .\\AIB_AVD_SAP800_InstallApps.ps1"
        ]
        timeout          = "2h"
        valid_exit_codes = [0, 3010]
    }
  ...
  ##############################################
  # 3. Multimedia Redirection Setup
  ##############################################
    provisioner "powershell" {
        inline = [
        "$path = 'C:\\AVDImage2'",
  ...
  ##############################################
  # 5. Install SAP 800 Custom Settings
  ##############################################
    provisioner "powershell" {
        inline = [
        "$path = 'C:\\AVDImage'",
        ...
        "}",
        "cd C:\\AVDImage",
        "Invoke-WebRequest -Uri 'https://avdweustc03.blob.core.windows.net/source/AIB_AVD_SAP800_CustomSettings.ps1' -OutFile 'C:\\AVDImage\\AIB_AVD_SAP800_CustomSettings.ps1'",
        "Start-Sleep -seconds 30",
        "& .\\AIB_AVD_SAP800_CustomSettings.ps1"
        ]
        timeout          = "2h"
        valid_exit_codes = [0, 3010]
    }
  ...
  ##############################################
  # 8. Post-Optimization Windows Updates
  ##############################################
  ...
  ##############################################
  # 11. Disabling Unwanted Services
  ##############################################
    provisioner "powershell" {
        inline = [
        "$path = 'C:\\AVDImage'",
  ...
  ##############################################
  # 15. Security Hardening of the Image
  ##############################################
    provisioner "powershell" {
        inline = [
        "$path = 'C:\\AVDImage'",
  ...
  ##############################################
  # 17. Cleanup Image Build Artifacts
  ##############################################
    provisioner "powershell" {
        inline = [
        "$path1 = 'C:\\AVDImage'",
